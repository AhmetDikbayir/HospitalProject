...
public class DataBank {
   protected static List<String> doctorIsimleri = new ArrayList<>();
   protected static List<String> doctorSoyIsimleri = new ArrayList<>();
   protected static List<String> unvanlar = new ArrayList<>();
   protected static List<String> hastaIsimleri = new ArrayList<>();
   protected static List<String> hastaSoyIsimleri = new ArrayList<>();
   protected static List<String> durumlar = new ArrayList<>();
